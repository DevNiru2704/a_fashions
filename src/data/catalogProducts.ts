// This file is auto-generated from catalog_images directory structure
// Product data for catalog pages
...
// Product listing data (for category pages)
...
// Generate full product details with default values for CMS
export function generateProductDetails(model: ProductModel): Product {
    return {
        slug: model.id,
        title: model.name,
        subtitle: "LEATHER",
...
export function getProductBySlug(slug: string): Product | undefined {
    const model = PRODUCT_MODELS.find(m => m.id === slug);
    return model ? generateProductDetails(model) : undefined;
}
