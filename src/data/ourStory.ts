// CMS-friendly content module for the Our Story page.
// Replace this export with data fetched from your CMS or API.

export const OUR_STORY_CONTENT = {
    about: {
        title: "ABOUT A FASHION",
        paragraphs: [
    ...
    process: {
        title: "ENSURING ABSOLUTE RESULTS",
        steps: [
            {
...
export default OUR_STORY_CONTENT;
